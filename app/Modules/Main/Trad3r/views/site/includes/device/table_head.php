...
<!--      <div class="table-group gr---><?//=$key ?><!--">-->
        <?php foreach ($group as $th):?>
          <div class="group-cell gr-<?=$key ?> table-cell">
                ...
                <div class="column-tool-group">
                  ...
                  <div class="column-tool-body">
                    <ul class="column-tool-list">
                      <li><button type="button" class="column-tool-item tool-sort-asc">Сортировать от А - Я</button></li>
                      <li><button type="button" class="column-tool-item tool-sort-desc">Сортировать от Я - А</button></li>
                    </ul>
                  </div>
                </div>
                <div class="column-tool-group">
