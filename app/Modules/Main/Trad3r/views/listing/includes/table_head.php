...
<div class="table-head">
  <div class="table-row">
    ...
    <div class="table-cell sequence-number">
      <?=$ths[ListingTableStructure::SEQUENCE_NUMBER]?>
    </div>
    ...
    <div class="table-cell text-center checkbox">
      <label class="checkbox">
        ...
        <span class="checkbox-text"><?=$ths[ListingTableStructure::SELECT_ALL]?></span>
      </label>
    </div>
    <div class="table-cell">
        <span><?=Yii::t('front', 'DATE_CREATED')?></span>
        <?=$this->render('@layouts/common/sort', [
            'isSortedColumn' => true, 
            'key' => ListingTableStructure::DATE_CREATED, 
            'sortedColumnsAsc' => $sortedColumnsAsc, 
            'sortedColumnsDesc' => $sortedColumnsDesc
        ])?>
    </div>
    <div class="table-cell">
      <span><?=$ths[ListingTableStructure::TITLE]?></span>
        <?=$this->render('@layouts/common/sort', [
            'isSortedColumn' => true,
