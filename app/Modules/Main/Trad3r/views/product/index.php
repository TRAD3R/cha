  ...
  <div class="modal-content">
    <div class="modal-content-wrapper">
      ...
      <div class="modal-content-tools jc-end">
        <button type="button" class="btn btn-primary" onclick="hideModal(true)">Сохранить</button>
        <button type="button" class="btn btn-muted" onclick="hideModal(false)">Отменить</button>
      </div>
    </div>
    <div class="btn btn-box btn-close-modal"  onclick="hideModal(false)">
